...
-- Dumping structure for table dbsprindik.ref_diklat
...
-- Dumping data for table dbsprindik.ref_diklat: ~2 rows (approximately)
DELETE FROM `ref_diklat`;
/*!40000 ALTER TABLE `ref_diklat` DISABLE KEYS */;
INSERT INTO `ref_diklat` (`id`, `keterangan`, `jadwal`, `status`) VALUES
	(1, 'Diklat ABC', '7 Hari', 'Belum Dimulai'),
	(2, 'Diklat BCD', '5 Hari', 'OK');
/*!40000 ALTER TABLE `ref_diklat` ENABLE KEYS */;
...
-- Dumping data for table dbsprindik.user: ~4 rows (approximately)
DELETE FROM `user`;
...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `nohp`, `nama`, `foto`) VALUES
	...
	(24, 'abcd', 'c4ca4238a0b923820dcc509a6f75849b', NULL, NULL, NULL, NULL),
	(27, 'coba3', 'c4ca4238a0b923820dcc509a6f75849b', 'coba@gmail.com', '3039499494', NULL, NULL),
	(45, 'coba4', 'c4ca4238a0b923820dcc509a6f75849b', 'coba1@gmail.com', '1233', NULL, NULL);
